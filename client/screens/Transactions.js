...
const Transactions = () => {
            ...
            for (const transaction of transactions) {
                ...
                if (user._id === transaction.senderId) {
                    ...
                    details.push({
                        ...
                        amount: singlePayment,
                        createdAt: transaction.createdAt,
                        settled: transaction.receivers.filter((rec) => rec.receiverId === user._id)[0].settled,
                        updatedAt: null,
                    });
                }
            }
    ...
    const handleSettle = async ({ receiverId, transactionId }) => {
                        ...
                        <View style={styles.transactionCard}>
                            ...
                            {item.sender === "You" && (
                                item.settled ? (
                                    ...
                                    <TouchableOpacity
                                        onPress={() => handleSettle({receiverId: item._id, transactionId: item.transactionId})}
                                    >
                                        <Text style={styles.settleButtonContainer}>
                                            Settle
                                        </Text>
                                    </TouchableOpacity>
                                )
